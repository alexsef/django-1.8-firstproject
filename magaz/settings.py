...
SECRET_KEY = 'jzq2pfxe$b%@d*)y3@68c^)y3r1ssac3%m#d5qn-y6#jl88rm^'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.path.join(BASE_DIR, 'yo-yo'),
    }
}
...
# STATICFILES_DIRS = (
#     ('static', '/users/alex/magaz/books/static')
# )
STATICFILES_DIRS = (
    os.path.join(BASE_DIR, "static"),
    '/users/alex/magaz/static/',
)

MEDIA_ROOT = os.path.join(os.path.dirname(BASE_DIR),
    '/users/alex/magaz/media_cdn'
)
